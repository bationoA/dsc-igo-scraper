"""This is the scraper class for the `UNICEF South Asia`'s website. It collects all publications
...
class SouthAsiaScraper:
    _organization_acronym: str = "UNICEF"
    _organization_region: str = "South Asia"
    ...
    def get_page_url(self, page_number: int) -> str:
        ...
        return f"https://www.unicef.org/rosa/research-and-reports/all-publications-south-asia?" \
               f"page=%2C{page_number}#listAnchor "
