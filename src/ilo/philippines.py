"""This is the scraper class for the ` ILO's Philippines` website. It collects all publications
...
class IloPhilippinesScraper:
    _organization_acronym: str = "ILO"
    _organization_region: str = "Philippines"
    ...
    def get_page_url(self, page_number: int) -> str:
        ...
        """
        url = "https://www.ilo.org/manila/publications/lang--en/nextRow--{}/index.htm"
