"""This is the scraper class for `WHO Europe` website. It collects all publications and their details using
...
class WhoEuropeScraper:
    _organization_acronym: str = "WHO"
    _organization_region: str = "Europe"
    ...
    def get_publications_list_from_api(self, skip: int = 0) -> dict:
        ...
        # API URL
        sf_site = "3a6a4c19-eabb-427a-a6b6-4b892a81038c"  # Specific to Europe
        sf_provider = "dynamicProvider475"  # Specific to Europe
        api_url = f"https://www.who.int/api/hubs/publications?sf_site={sf_site}" \
                  ...
                  f"TrimmedTitle&$format=json&$skip={skip}&$top={self.api_rqst_max_items}&$count=true"
        ""
